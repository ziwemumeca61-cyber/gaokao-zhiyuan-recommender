@echo off
chcp 65001 >nul
title 打包：生成"开箱即用"绿色版
setlocal enabledelayedexpansion

rem ====== 在一台【联网的 Windows】上运行本脚本，生成可分发的绿色版 ======
rem 产物在 dist\高考志愿推荐系统\ ，把它压成 zip 发给客户即可。
rem 客户解压后双击其中的「启动应用.bat」就能用，无需安装任何东西。

cd /d "%~dp0\.."
set "PYVER=3.11.9"
set "PYDIR=python-3.11"
