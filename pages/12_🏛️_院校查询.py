...
from gaokao.data_loader import load_majors, load_schools  # noqa: E402
from gaokao.recommender import ml_model, rank_based  # noqa: E402
from gaokao.recommender.history import aggregate_cached  # noqa: E402
...
majors = load_majors()
stats = aggregate_cached(student.province, student.subject_type)
